...
public class GameStart extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        techList.add("Hydrogen");
        techList.add("Gold");
        techList.add("Boron");
        techList.add("Samarium");
        techList.add("Germanium");
        techList.add("Neon");
        techList.add("Magnesium");
        techList.add("Oxygen");
        techList.add("Potassium");
        techList.add("Chromium");
        techList.add("Lawrencium");
        techList.add("Hassium");
        techList.add("Actinium");
        techList.add("Neptunium");
        techList.add("Silicon");
        // Put all the technology names with technology image resource ids in map.
        map.put(techList.get(0), R.drawable.one);
        map.put(techList.get(1), R.drawable.two);
        map.put(techList.get(2), R.drawable.three);
        map.put(techList.get(3), R.drawable.four);
        map.put(techList.get(4), R.drawable.five);
        map.put(techList.get(5), R.drawable.six);
        map.put(techList.get(6), R.drawable.seven);
        map.put(techList.get(7), R.drawable.eight);
        map.put(techList.get(8), R.drawable.nine);
        map.put(techList.get(9), R.drawable.ten);
        map.put(techList.get(10), R.drawable.eleven);
        map.put(techList.get(11), R.drawable.twelve);
        map.put(techList.get(12), R.drawable.thirteen);
        map.put(techList.get(13), R.drawable.fourteen);
        map.put(techList.get(14), R.drawable.fiften);
        ...
        countDownTimer = new CountDownTimer(millisUntilFinished, 1000) {
            ...
            public void onFinish() {
                ...
                if (index > techList.size() - 1){
                    ...
                    Intent intent = new Intent(GameStart.this, GameOverActivity.class);
