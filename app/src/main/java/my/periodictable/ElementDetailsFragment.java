...
import my.periodictable.Elements;
import my.periodictable.Isotope;
import my.periodictable.Isotopes;
import my.periodictable.ElementUtils;
import my.periodictable.PreferenceUtils;
import my.periodictable.UnitUtils;
...
public class ElementDetailsFragment extends DialogFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mImageGif = root.findViewById(R.id.gifview);
...
//            return;
//        }
//        final int pageId = ElementUtils.getElementGif(mElement.number);
//        final Uri uri = Uri.parse(String.format("https://%s.m.wikipedia.org/wiki/%s",
//                g(R.string.wikiLang), getString(pageId)));
